...
"lista de palabras"
## list_str = numpy.lower().split()

"recorro lista obteniendo duplas"
# print(collections.Counter(list_str))
"y aplico most common que devuelve la mayo dupla"
print(Counter(numpy.lower().split()).most_common(1))
