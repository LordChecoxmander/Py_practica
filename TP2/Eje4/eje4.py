...
"""
# divido evaluar en "resumen:" y por oracion
str_tit, str_res = list(str(evaluar.split(".")).split("resumen"))

print(type(str_res)) # -> xq no es un list???

lis_tit = list(str_tit).remove("\\n")